...
\newtheorem{corollary}{Corolllary}
...
\newcommand{\IfThenELse}{\mathsf{if} \dots \mathsf{then} \dots \mathsf{else}}
...
\newcommand{\Etor}{\mathbf{ETR}}
\newcommand{\Bern}[2]{\text{Bernoulli}(#1,#2)}


\newcommand{\LY}{\lambda Y}
\newcommand{\PLY}{P\lambda Y}
\newcommand{\Gfin}{\text{PBHORS}^{<\infty}}
\newcommand{\Flipinf}{\text{BFLIP}^{\infty}}
%P\lambda Y^{<\infty}}
\newcommand{\Ginf}{\text{PBHORS}^{\infty}}
\newcommand{\GRat}{\text{PRatHORS}^{\infty}}
\newcommand{\FlipRat}{\text{RatFLIP}^{\infty}}
%P\lambda Y^{\infty}}
...
\newcommand{\1}{o}
\newcommand{\phors}{{(\mathcal{N}, \mathcal{T}, \mathcal{D}, S)}}
