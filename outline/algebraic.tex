...
In the previous section we have seen that a PHORS, seen through $\PLY$ as a fixpoint, can be associated with formal power series defined as minimal solutions of an equational system. In practice, computing such power series directly can be very hard; in particular, as we saw, these capture properties like AST or PAST which are undecidable in general. However, when the equational system defining them is algebraic, that is, expressed in terms of finitely many polynomial equations, it becomes possible to extract information, or even compute, such power series indirectly. 
