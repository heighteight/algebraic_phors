...
$a(x)=\sum_n a_n x^n$ whose annihilating polynomial $p(w, x)$ satisfies $p(0,0)= 0$ and $\partial_wp(0,0)\neq 0$ can be computed directly via a ``multinomial formula'' derived from the Lagrange inversion formula  \cite{BANDERIER_DRMOTA_2015}.
