...
%  		\end{itemize}
  ...
  algebraic power series can always be analytically extended over all but finitely many points of the unitary circle; by contrast, by Fabry's gap theorem, if $\lim_n p_n/n$ diverges, then $a$ has the whole unitary circle as a natural border.
