...
\begin{remark}
Beyond AST/PAST, the algebraicity of $a_\gphors(z)$ ensures the computability of 
its coefficients $\mathbb P(\gphors\downarrow_i)$, cf.~Remark
\ref{coefficients-rational}.
\end{remark}