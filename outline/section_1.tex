...
From a polynomial equation like this it is possible to extract informatios about the generating function and the corresponding sequence that it would be otherwise very hard to compute directly.
...
More precisely, our contributions can be resumed as follows:
\begin{varitemize}
