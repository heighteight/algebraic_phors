...
formal grammars and 
 \emph{first-order} programming languages (also in the probabilistic case, cite people).  However, extending this natural and powerful approach to functional programs is challenging, as it is not obvious how to associate \emph{higher-order} functions  with sequences of real numbers, as required to induce a generating function. 
...
As mentioned before, linearity has been recognized as a key factor to ensure the decidability of the AST problem for PHORS (cite Ong).
