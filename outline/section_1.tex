...
On the other, our results suggest the \emph{robustness} of the class of PHORS individuated by \cite{DBLP:conf/lics/LiMO22}, as all PHORS typable in our discipline are shown 
 {equivalent} (in terms of both probabilistic termination and the corresponding language) to the affine PHORS, even though producing the corresponding affine program effectively may lead to an exponential blow up.
