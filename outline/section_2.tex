...
In this work we define two classes of PHORS that extend the affine PHORS of (Ong et al.) by allowing bounded and unbounded duplications, still preserving decidability. A natural question is whether such classes also extend the corresponding class of branch languages.
