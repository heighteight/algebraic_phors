...
the only possibility is to give type $\nonterm(L)=!_\infty \tau\to \tau$, but then $L$ cannot be applied to the function $f\circ f:\tau$, as the latter is neither a parameter nor a non-terminal. 
