...
We now introduce a class of PHORS that extends the $\Gfin$ by admitting infinite grades $!_\infty$, corresponding to parameters that may be used an \emph{unbounded} number of times. Moreover, thanks to the composability of algebraic power series, and unlike the PAHORS and $\Gfin$, the $\Ginf$ are closed under \emph{composition}.
...
$\model{\gphors_1\circ_L\gphors_2}^{\Rsemiring}(w_{\model{\C P}})=
\model{\gphors_1}^{\Rsemiring}(\model{\gphors_2}^{\Rsemiring}(w_{\model{\C P}}),w_{\model{\C P}})$.
%
%
