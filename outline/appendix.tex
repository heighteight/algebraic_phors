...
We don't prove directly the last lemma, as the induction hypothesis would be not sufficient, but we pass through an intermediate step that uses some kind of reducibility candidates.
\begin{definition}
