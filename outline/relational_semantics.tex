...
Let us first introduce formal power series; for more details about them and their applications to combinatorics we refer to \cite{DBLP:books/daglib/0023751}, \cite{DBLP:series/tmsc/KauersP11}. Given a set $\Sigma$, 
...
In \cite{DBLP:journals/corr/abs-2501-15637} they also consider the interpretation of
