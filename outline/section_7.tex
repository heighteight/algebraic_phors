...
Finally, we hope that these combinatorial methods might help in the still open problem of placing the decidability of AST for PHORS in the arithmetic hierarchy. 
%
